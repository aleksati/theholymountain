  ...
  <div className="bg-primary-dark text-primary-dark pb-4 text-xl">
    <div className="container pb-4 mx-auto pt-6 space-y-6 px-2">
        ...
        <div className="grid grid-rows-1 grid-cols-1 md:grid-cols-2 gap-2 text-lg">
          ...
          <div className="backdrop-brightness-150 p-2">
            <p className="italic p-2">
              ...
              this tense area where light might imply darkness and darkness can
              signify light.
            </p>
      ...
      <div className="border border-secondary-skin-dark p-4 space-y-4">
        ...
        <p>
          The Holy Mountain is a genre-defying and critically acclaimed
          synth-pop trio from Norway. With their conceptually unique style and
          taste for the dark and transcendental, the band is described as a
          cross between the TV series Twin Peaks and the American synth-pop act
          Beach House (US), with clear roots from classical minimalist
          traditions.
        </p>
        <div>
